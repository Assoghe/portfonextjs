...
export const portfolioData = [
  {
    ...
    case: {
      ...
      veilleImgOne: "/assets/img/usecase/mangasfan/veille-one.png",
      veilleImgTwo: "/assets/img/usecase/mangasfan/veille-two.png",
      ...
      maquetteImgThree: "/assets/img/usecase/mangasfan/maquette-three.png",
      ...
      maquetteImgFour: "/assets/img/usecase/mangasfan/maquette-four.png",
...

  {
    ...
    case: {
      ...
      veilleImgOne: "/assets/img/usecase/tattoo/veille-img-one-tattoo.png",
      veilleImgTwo: "/assets/img/usecase/tattoo/veille-img-two-tattoo.png",
      ...
      architectureImg: "/assets/img/usecase/tattoo/architecture-tattoo.png",
      ...
      maquetteImgTwo: "/assets/img/usecase/tattoo/maquette-two-tattoo.png",
      ...
      maquetteImgThree: "/assets/img/usecase/tattoo/maquette-three-tattoo.png",
      ...
      maquetteImgFour: "/assets/img/usecase/tattoo/maquette-four-tattoo.png",
      ...
      footerImg: "/assets/img/usecase/tattoo/footer-tattoo.png"
    }
  },

  {
    ...
    case: {
      ...
      descriptionImageCover: "/assets/img/usecase/good/cover-good.png",
      ...
      veilleImgOne: "/assets/img/usecase/good/veille-img-one.png",
      veilleImgTwo: "/assets/img/usecase/good/veille-img-two.png",
      ...
      architectureImg: "/assets/img/usecase/good/architecture-good.png",
      ...
      wireframeImg: "/assets/img/usecase/good/wireframe-good.png",
      ...
      designsystemImg: "/assets/img/usecase/good/designsystem-good.png",
      maquetteText: "Dans cette section, vous trouverez quelques pages des maquettes que j'ai réalisées pour Good Family.",
      maquetteImgOne: "/assets/img/usecase/good/maquette-one-good.png",
      maquetteHeadingOne: "Page d'accueil",
      ...
      maquetteImgTwo: "/assets/img/usecase/good/maquette-two-good.png",
      ...
      maquetteImgThree: "/assets/img/usecase/good/maquette-three-good.png",
      ...
      maquetteImgFour: "/assets/img/usecase/good/maquette-four-good.png",
      ...
      conclusionText: "",
      footerImg: "/assets/img/usecase/good/footer-good.png"
    }
  },
]
